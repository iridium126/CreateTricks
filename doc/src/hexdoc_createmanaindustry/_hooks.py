...
import hexdoc_createmanaindustry

from .__gradle_version__ import FULL_VERSION, GRADLE_VERSION
from .__version__ import PY_VERSION


class CreateManaIndustryPlugin(ModPluginImpl):
    @staticmethod
    @hookimpl
    def hexdoc_mod_plugin(branch: str) -> ModPlugin:
        return CreateManaIndustryModPlugin(branch=branch)


class CreateManaIndustryModPlugin(ModPluginWithBook):
    @property
    @override
    def modid(self) -> str:
        return "createmanaindustry"
    ...
    def jinja_template_root(self) -> tuple[Package, str]:
        return hexdoc_createmanaindustry, "_templates"
