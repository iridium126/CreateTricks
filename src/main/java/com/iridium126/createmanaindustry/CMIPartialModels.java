...
public final class CMIPartialModels {
    ...
    public static final PartialModel STRESSED_SHAFTLESS_COGWHEEL = block("temporary_kinetics/cogwheel_shaftless");
    public static final PartialModel STRESSED_SHAFTLESS_LARGE_COGWHEEL = block("temporary_kinetics/large_cogwheel_shaftless");
    public static final PartialModel STRESSED_COGWHEEL_SHAFT = block("temporary_kinetics/cogwheel_shaft");
    public static final PartialModel STRESSED_SHAFT_HALF = block("temporary_kinetics/shaft_half");
    public static final PartialModel STRESSED_SHAFT = block("temporary_kinetics/shaft");
    public static final PartialModel STRESSED_COGWHEEL = block("temporary_kinetics/cogwheel");
